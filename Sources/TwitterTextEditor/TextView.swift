...
extension DelegateForwarder: UITextViewDelegate, TextViewDelegate {}
...
final class TextView: UITextView {
    ...
    lazy var delegateForwarder: DelegateForwarder = DelegateForwarder(forwardTargets: [])
    ...
    var textViewDelegate: TextViewDelegate? {
        ...
        set {
            delegateForwarder.setDelegate(delegate: newValue, for: textViewDelegateSelectors)
    ...
    override var delegate: UITextViewDelegate? {
        ...
        set {
            delegateForwarder.setDelegate(delegate: newValue, for: scrollViewDelegateSelectors)
            super.delegate = delegate
        }
    }
}
